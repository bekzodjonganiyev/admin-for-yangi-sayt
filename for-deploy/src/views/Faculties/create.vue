        ...
        <div class="flex justify-evenly w-full">
          <div class="space-y-6 news">
            ...
            <InputComponent
              ...
              class="w-full"
              name="Fakultet nomi"
              v-model="fakultet.title_uz"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.haqida_uz"
              name="Fakultet haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.maqsad_uz"
              name="Fakultet maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.kafedras_uz"
            ...
            <InputComponent
              ...
              class="w-full"
              name="Fakultet nomi"
              v-model="fakultet.title_ru"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.haqida_ru"
              name="Fakultet haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.maqsad_ru"
              name="Fakultet maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.kafedras_ru"
              name="Fakultet kafedralari"
            />
            ...
            <InputComponent
              ...
              class="w-full"
              name="Fakultet nomi"
              v-model="fakultet.title_en"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.haqida_en"
              name="Fakultet haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.maqsad_en"
              name="Fakultet maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="fakultet.kafedras_en"
              name="Fakultet kafedralari"
            />
          </div>
        </div>
