    ...
    <div class="my-5">
        ...
        >
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr
                v-for="(faculty, index) in customers"
                :key="index"
                class="bg-white"
              >
                ...
                <td class="p-3 text-sm text-gray-700 whitespce-nowrap">
                  <p
                    v-for="(kafedra, index) in faculty.kafedras_uz"
                    :key="index"
                  >
                    {{ kafedra }}
                  </p>
                ...
                <td class="">
                  ...
                  <button
                    type="button"
                    @click="deleteFaklultet(faculty._id)"
      ...
      <div class="flex justify-between items-center mt-16">
        ...
        <select class="w-96 p-2" ref="fakultet" @change="filterByFakultet">
          ...
          <option v-for="name in customers" :value="name._id">
            {{ name.title_uz }}
          </option>
        </select>
      </div>
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                ...
                <td class="whitespce-nowrap">
                  ...
                  <button
                    type="button"
                    @click="deleteFakXodim(xodim._id)"
                    class="bg-red-400 py-1 px-2 rounded"
                  >
                    Delete
                  </button>
  ...
  methods: {
    ...
    filterByFakultet() {
      ...
      if (id === "all") {
        ...
        return (this.filteredArray = this.employes.filter(
          (item) => item.fakultet_id === id
        ));
      }
    },
  },
