<template>
  ...
  <div v-else>
    <div class="bg-neutral-900 min-h-screen">
      ...
      <div
        class="bg-neutral-900 flex justify-evenly md:flex-none md:col-span-12"
      >
        <div class>
          <img
            class="min-w-full w-96 my-10"
        ...
        >
          <div class="px-5">
            ...
            <button
              type="submit"
              class="rounded w-full py-3 mt-2 mb-10 bg-blue-900 text-white"
            >
              Register
            </button>
          </div>
        ...
        >
          <div class="px-5">
            ...
            <span
              class="cursor-pointer ml-16 hover:text-indigo-600"
              @click="claerLocalStorage"
              >Bo'lim boshlig'i orqali ro'yxatdan o'tish</span
            >
          </div>
        </form>
      </div>
