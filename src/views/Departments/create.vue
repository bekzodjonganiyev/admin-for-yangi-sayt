        ...
        <div class="flex justify-evenly w-full">
          <div class="space-y-6 news">
            ...
            <InputComponent
              ...
              class="w-full"
              name="Bo`lim nomi"
              v-model="bolim.title_uz"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.haqida_uz"
              name="Bo`lim haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.maqsad_uz"
              name="Bo`lim maqsadi"
            />
            ...
            <InputComponent
              ...
              class="w-full"
              name="Bo`lim nomi"
              v-model="bolim.title_ru"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.haqida_ru"
              name="Bo`lim haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.maqsad_ru"
              name="Bo`lim maqsadi"
            />
            ...
            <InputComponent
              ...
              class="w-full"
              name="Bo`lim nomi"
              v-model="bolim.title_en"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.haqida_en"
              name="Bo`lim haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="bolim.maqsad_en"
              name="Bo`lim maqsadi"
            />
          </div>
        </div>
