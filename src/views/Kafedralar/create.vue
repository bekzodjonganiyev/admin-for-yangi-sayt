        ...
        <div class="flex justify-evenly w-full">
          <div class="space-y-6 news">
            ...
            <InputComponent
              ...
              class="w-full"
              name="Kafedra nomi"
              v-model="kafedra.title_uz"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.haqida_uz"
              name="Kafedra haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.maqsad_uz"
              name="Kafedra maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.yonalish_uz"
            ...
            <InputComponent
              ...
              class="w-full"
              name="Kafedra nomi"
              v-model="kafedra.title_ru"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.haqida_ru"
              name="Kafedra haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.maqsad_ru"
              name="Kafedra maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.yonalish_ru"
              name="Kafedra yo'nalishlari"
            />
            ...
            <InputComponent
              ...
              class="w-full"
              name="Kafedra nomi"
              v-model="kafedra.title_en"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.haqida_en"
              name="Kafedra haqida"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.maqsad_en"
              name="Kafedra maqsadi"
            />
            <TextAreaComponents
              required
              class="w-full"
              v-model="kafedra.yonalish_en"
              name="Kafedra yo'nalishlari"
            />
            ...
            >
              ...
              <option v-for="faculty in faculties" :value="faculty._id">
                {{ faculty.title_uz }}
              </option>
            </select>
          </div>
...
export default {
  ...
  methods: {
    ...
    getFaculty() {
      http.get("Fak_data/all").then((res) => {
