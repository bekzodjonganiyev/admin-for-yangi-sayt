      ...
      <div class="flex justify-between">
        ...
        <router-link to="/products/create">
          <button
            ...
            type="button">Sertifikat Qo'shish</button>
        </router-link>
      </div>
      <div class="h-full w-full">
        <p class="text-xl my-6">Sertifikatlar</p>
        <div class="overflow-auto p-5 bg-white rounded-lg shadow hidden md:block">
          <table class="w-full">
            <thead class="bg-gray-100">
              <tr>
                <th class="w-20 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left">
                  ID</th>
                <th class="w-32 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left">F.I.O</th>
                <th class="w-32 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left">tahrirlash
                </th>
                <th class="w-32 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left">O'chirish
                </th>
              </tr>
            </thead>
