    ...
    <div class="my-5">
      <div class="flex">
        ...
        <div class="inline-flex justify-end ml-80">
          <div class="flex mr-5 cursor-pointer">
            <img
              class="w-7 h-7 fill-blue-900 mt-2 cursor-pointer rotate-180"
          ...
          <div class="flex mr-5 cursor-pointer">
            <img
              class="fill-blue-900 w-7 h-7 mt-2 cursor-pointer text-blue-900"
              src="../../assets/export.svg"
              alt
            />
