            ...
            <div class="my-8 mx-40 rounded-xl drop-shadow-md pt-20 pb-20 bg-white">
                <div class="flex justify-evenly">
                    <div class="space-y-6">
                        ...
                        />
                        <InputComponent class="w-full" name="Name" v-model="editItems.name" />
                        <InputComponent class="w-full" name="Cost" v-model="editItems.cost" />
                        <InputComponent class="w-full" name="Price" v-model="editItems.price" />
                    </div>
                    <div class="space-y-6">
                        <InputCompone
                            class="w-full"
                        ...
                        <InputComponent class="w-full" name="Code" v-model="editItems.code" />
                        <input type="checkbox" id="checkbox" v-model="editItems.is_primary" />
...
export default {
    ...
    setup() {
        ...
        function itemUpdate() {
            http.put(`/item/${route.params.id}/update/`,
                {
