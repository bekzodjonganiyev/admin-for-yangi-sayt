  ...
  <Layout>
    <div class="container">
      ...
      <div class="my-5 ">
        ...
        >
         <div class="space-y-6">
            <label class="sm:text-sm bg-white top-9 left-2 relative p-1 text-sky-600" for="input">Shop</label>
          <input
            type="text"
            placeholder="Penny"
          ...
          <label class="sm:text-sm text-sky-600 relative p-1 top-9 left-2 bg-white" for="date">Delivery date *</label>
          <input
            type="date"
          ...
          <div class="space-y-6">
            <label class="text-sky-600 sm:text-sm p-1 bg-white top-9 left-2 relative" for="date">Ordered date</label>
          <input
            type="date"
            v-model="returnDate"
            class="w-full border border-slate-300 rounded-md py-2 pl-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
          />
             <label class="sm:text-sm bg-white left-2 top-9 p-1 text-sky-600 relative" for="input">Status</label>
             <input
            type="text"
            placeholder="Active"
            class="w-full border border-slate-300 rounded-md py-2 pl-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
