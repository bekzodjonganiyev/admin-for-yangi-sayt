    ...
    <form @submit.prevent="postData">
      <div class="my-8 mx-40 rounded-xl drop-shadow-md pt-20 pb-20 bg-white">
        <div class="space-y-6 news">
          ...
          <InputComponent
            class="w-full"
            name="Syllabusni nomini kiriting"
            type="text"
          ...
          >
            ...
            <option
              class="text-black"
              v-for="(kafedra, index) in kaferdas"
              :value="kafedra.title_uz"
              :key="kafedra._id"
            >
              {{ kafedra.title_uz }}
            </option>
