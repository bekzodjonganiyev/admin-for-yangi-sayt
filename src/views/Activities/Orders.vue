        ...
        >
          <table class="w-full">
            <thead class="bg-gray-100">
              <tr>
                <th
                  class="w-40 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left"
                >
                  Rasm
                </th>
                <th
                ...
                <th
                  class="w-20 text-zinc-400 p-3 text-sm font-semibold tracking-wide text-left"
                >
                  Amallar
                </th>
              </tr>
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                <td class="p-3 text-sm text-gray-700 whitespce-nowrap">
                  <img
                    class="w-10 rounded"
                    v-bind:src="url + '/uploads/' + customer.photo"
                    alt=""
                  />
                </td>
                <td class="p-3 text-sm text-gray-700 whitespce-nowrap">
