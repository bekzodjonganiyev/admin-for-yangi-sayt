      ...
      <div class="my-8 mx-40 rounded-xl drop-shadow-md pt-20 pb-20 bg-white">
        <div class="flex justify-evenly w-full">
          <div class="space-y-6 news">
            ...
            <hr />
            <InputComponent required class="w-full" name="Yangilik nomi uz" v-model="faoliyat.title_uz" />
            <TextAreaComponents required class="w-full" v-model="faoliyat.body_uz" name="Yangilik matni uz" />

            <h1 class="news-info">Faoliyat rus tilida qo'shish</h1>
            <hr />
            <InputComponent required class="w-full" name="Yangilik nomi ru" v-model="faoliyat.title_ru" />
            <TextAreaComponents required class="w-full" v-model="faoliyat.body_ru" name="Yangilik matni ru" />

            <h1 class="news-info">Faoliyat ingliz tilida qo'shish</h1>
            <hr />
            <InputComponent required class="w-full" name="Yangilik nomi en" v-model="faoliyat.title_eng" />
            <TextAreaComponents required class="w-full" v-model="faoliyat.body_eng" name="Yangilik matni en" />
            <div class="news-date ">

              <InputComponent required class="w-full" name="Faoliyat kiritilgan vaqti" type="date"
                v-model="faoliyat.date" />
              <InputComponent required class="w-full" name="Rasm yuklang" type="file" @change="onFileUpload" />
...
export default {
  ...
  methods: {
    ...
    postData() {
      ...
      http.post('/Faoliyat_data/add', formData
      ).then((a) => {
